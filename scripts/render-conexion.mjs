...
const full = `${os.homedir()}/Desktop/faro-historia-conexion-1080x1920.png`;
const prev = `${DIR}/faro-conexion-540x960.png`;
const browser = await chromium.launch();
const page = await browser.newPage({ viewport: { width: 1080, height: 1920 }, deviceScaleFactor: 1 });
await page.goto('file://' + DIR + '/faro-conexion.html', { waitUntil: 'networkidle' });
